...
from util import find_max_epoch, print_size, sampling, calc_diffusion_hyperparams
...
def generate(output_directory,
    ...
    num_batches = testing_data.shape[0]//batch_size
    len = testing_data.shape[0]//num_batches * num_batches
    testing_data = testing_data[:len]
    testing_data = np.split(testing_data, num_batches, 0)
    ...
    for i, batch in enumerate(testing_data):
        ...
        print('generated {} utterances of random_digit at iteration {} in {} seconds'.format(batch_size,
                                                                                             ckpt_iter,
